...
int compare_hands(deck_t * hand1, deck_t * hand2) {
  hand_eval_t evaluated_hand1 = evaluate_hand(qsort(hand1->cards, hand1->n_cards, sizeof(card_t *), &card_ptr_comp));
  hand_eval_t evaluated_hand2 = evaluate_hand(qsort(hand2->cards, hand2->n_cards, sizeof(card_t *), &card_ptr_comp));
